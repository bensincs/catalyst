...
export function dependenciesFor(app?: Pick<Application, "dependencies" | "wiring">): Dependency[] {
...
export function DeploymentForm({
  ...
  const [dependencies, setDependencies] = useState<Dependency[]>(() => dependenciesFor(app));
